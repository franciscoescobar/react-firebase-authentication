      ...
      <div>
        ...
        {user && (
          ...
          <span>
            ...
            <span>
              <button type="button" className="button" onClick={this.onSendPasswordResetEmail}>
                Send Password Reset
              </button>
            </span>
          </div>
...
export default compose(withAuthorization(condition), withEmailVerification)(AdminPage);